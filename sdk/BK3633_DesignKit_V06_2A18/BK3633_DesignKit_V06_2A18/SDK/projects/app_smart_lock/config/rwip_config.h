...
//#define CFG_CUT_CODE_SIZE       1 // code size cut for (CFG_ROLE == 2)
...
#ifdef CFG_CUT_CODE_SIZE
#define CFG_BLE_EXT_ADV                 0
#define CFG_BLE_PER_SYNC_TRANSFER       0
#define CFG_BLE_PHY_UPDATE              0
// white list, rslv list, per adv list, random address, pairing, encrypt
#define CFG_BLE_SMP                     0
#undef CFG_NVDS
#else
#define CFG_BLE_EXT_ADV                 1
#define CFG_BLE_PER_SYNC_TRANSFER       1
#define CFG_BLE_PHY_UPDATE              1
// white list, rslv list, per adv list, random address, pairing, encrypt
...
/******************************************************************************************/
    ...
    #undef BLE_PHY_2MBPS_SUPPORT
    #define BLE_PHY_2MBPS_SUPPORT                           0
    #undef BLE_PHY_CODED_SUPPORT
